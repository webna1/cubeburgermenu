export const MENU = [
  {
    ...
    items:[
      {nm_en:"Dynamite Shrimps", nm_ar:"روبيان ديناميت",
       ...
       ds_ar:"روبيان مقلي مقرمش متبّل بصلصة مايونيز حارّة ولاذعة.", price:"14,000", img:"/images/item-dynamite-shrimps.jpg", imgPos:"center 35%"},
      {nm_en:"Dynamite Chicken", nm_ar:"دجاج ديناميت",
       ...
       ds_ar:"قطع صدر دجاج مقلية مقرمشة بصلصة مايونيز حارّة ولاذعة.", price:"9,750", img:"/images/item-dynamite-chicken.jpg", imgPos:"center 40%"},
      {nm_en:"Crab Balls 5 pcs", nm_ar:"كرات السلطعون ٥ قطع",
       ...
       ds_ar:"خمس كرات من لحم السلطعون وجبنة الكريمة والبصل الأخضر، تُقدّم مع صلصة الديناميت الحارّة.", price:"8,500", img:"/images/item-crab-balls.jpg", imgPos:"center 60%"},
      {nm_en:"Mozzarella Cubes  6 pcs", nm_ar:"مكعّبات الموزاريلا  ٦ قطع",
       ...
       ds_ar:"جبنة موزاريلا مقلية بطبقة مقرمشة، تُقدّم مع صلصة المارينارا المنزليّة.", price:"7,750", img:"/images/item-mozzarella-cubes.jpg", imgPos:"center 50%"},
      {nm_en:"Jalapeño Cheese Nuggets  9 pcs", nm_ar:"ناغتس الجبن والهالبينو ٩ قطع",
       ...
       ds_ar:"مزيج مقلي من الجبن والفلفل الحار، يُقدّم مع صلصة خاصة.", price:"7,750", img:"/images/item-jalapeno-nuggets.jpg", imgPos:"center 45%"},
      {nm_en:"Onion Rings 10 pcs", nm_ar:"حلقات البصل ١٠ قطع",
       ds_en:"Ten fried crispy onion rings served with BBQ dipping sauce.",
       ds_ar:"عشر حلقات بصل مقرمشة تُقدّم مع صلصة الباربكيو.", price:"5,500", img:"/images/item-onion-rings.jpg", imgPos:"center 55%"}
    ]
  },
  {
    ...
    items:[
      {nm_en:"French Fries", nm_ar:"بطاطا مقلية", price:"3,500", img:"/images/item-french-fries.jpg", imgPos:"center 40%"},
      {nm_en:"Curly Fries", nm_ar:"بطاطا كيرلي", price:"5,250", img:"/images/item-curly-fries.jpg", imgPos:"center 40%"},
      {nm_en:"Cube French Fries", nm_ar:"بطاطا كيوب",
       ds_en:"Served with garlic mayo.", ds_ar:"تُقدّم مع مايونيز الثوم.", price:"5,750", img:"/images/item-cube-fries.jpg", imgPos:"center 40%"},
      {nm_en:"Texas Fries", nm_ar:"بطاطا تكساس",
       ds_en:"Cheesy fries topped with hot chili sauce, jalapeños & garnished with beef bacon.",
       ds_ar:"بطاطا بالجبن مع صلصة الفلفل الحار والهالبينو ولحم بقري مدخّن.", price:"8,750", img:"/images/item-texas-fries.jpg", imgPos:"center 55%"},
      {nm_en:"Cube Style Fries", nm_ar:"بطاطا بنكهة كيوب",
       ...
       ds_ar:"مكعّبات بطاطا بالجبن مع صلصة الفلفل والبصل الأخضر ولحم بقري مدخّن.", price:"8,750", img:"/images/item-cube-style-fries.jpg", imgPos:"center 40%"},
      {nm_en:"Chicken Alfredo Fries", nm_ar:"بطاطا ألفريدو بالدجاج",
       ...
       ds_ar:"صلصة بيضاء كريميّة مع شرائح دجاج مشوي فوق البطاطا والجبن، مع البارميزان والبصل الأخضر.", price:"8,750", img:"/images/item-alfredo-fries.jpg", imgPos:"center 65%"}
    ]
  },
  {
    ...
    items:[
      {nm_en:"Caesar Salad", nm_ar:"سلطة سيزر",
       ...
       img:"/images/item-caesar-salad.jpg", imgPos:"center 50%",
       opts:[
      ...
      {nm_en:"Summer Garden", nm_ar:"حديقة الصيف",
       ...
       ds_ar:"خضار مشكّلة وطماطم كرزيّة وخيار وملفوف أحمر وبصل أخضر وكروتون بصلصة الفيتا، مع شرائح الونتون والزيتون الأسود.", price:"8,500", img:"/images/item-summer-garden.jpg", imgPos:"center 45%"},
  ...
  },
  {
    ...
    items:[
      {nm_en:"Buffalo · Honey Mustard · BBQ", nm_ar:"بافلو · هاني مسترد · باربكيو",
       ...
       img:"/images/item-boneless-classic.jpg", imgPos:"center 45%",
       opts:[
      ...
      {nm_en:"Parmesan Buffalo · Crazy Bites · Garlic Parmesan", nm_ar:"بارميزان بافلو · كريزي بايتس · غارليك بارميزان",
       ds_en:"Bites of chicken breast, hand-breaded, deep fried to golden crispy & tossed in your choice of our homemade sauces.",
       ds_ar:"قطع صدر دجاج مغطّاة يدويًا ومقليّة حتى الذهبيّة والقرمشة، متبّلة بصلصتك المفضّلة.",
       img:"/images/item-boneless-premium.jpg", imgPos:"center 40%",
       opts:[
  ...
  },
  {
    ...
    items:[
      {nm_en:"Buffalo · Honey Mustard · BBQ", nm_ar:"بافلو · هاني مسترد · باربكيو",
       img:"/images/item-wings-classic.jpg", imgPos:"center 50%",
       opts:[
      ...
      {nm_en:"Garlic Parmesan · Crazy Wings · Buffalo & BBQ Mix", nm_ar:"غارليك بارميزان · كريزي وينغز · مكس بافلو وباربكيو",
       img:"/images/item-wings-premium.jpg", imgPos:"center 40%",
       opts:[
  ...
  },
  {
    ...
    intro_en:"Made with selected 100% pure premium quality beef on a freshly baked toasted bun with fresh veggies & house-made sauces. All beef burgers are now 150g.",
    ...
    items:[
      {nm_en:"Cube Burger", nm_ar:"برجر كيوب",
       ds_en:"150g premium quality beef, mixed cheese, lettuce, tomato, onions & pickles, basted with our special Cube sauce.",
       ds_ar:"١٥٠غ لحم أنغوس، جبن مشكّل، خس، طماطم، بصل ومخلّل، مع صلصة كيوب الخاصة.", sm:["11,000","14,000"], img:"/images/item-cube-burger.jpg", imgPos:"30% 50%"},
      {nm_en:"Classic Burger", nm_ar:"برجر كلاسيك",
       ds_en:"150g premium quality beef, mixed cheese, ketchup, garlic mayo, mustard, lettuce, tomato, onions & pickles.",
       ds_ar:"١٥٠غ لحم أنغوس، جبن مشكّل، كاتشب، مايونيز الثوم، مسترد، خس، طماطم، بصل ومخلّل.", sm:["11,000","14,000"], img:"/images/item-classic-burger.jpg", imgPos:"center 30%"},
      {nm_en:"Hard Rock Style", nm_ar:"هارد روك ستايل",
       ds_en:"150g premium quality beef, white cheese, tomato, pickles, garlic mayo with sautéed mushrooms & onions, topped Hard Rock style.",
       ds_ar:"١٥٠غ لحم أنغوس، جبن أبيض، طماطم، مخلّل، مايونيز الثوم مع فطر وبصل مشوّح، بأسلوب هارد روك.", sm:["12,000","15,000"], img:"/images/item-hard-rock.jpg", imgPos:"center 50%"},
      {nm_en:"Dynamite Burger", nm_ar:"برجر ديناميت",
       ds_en:"150g premium quality beef, cheddar, green onions, tomato, pickles, lettuce, topped with sriracha hot chili & basted with house-made dynamite sauce.",
       ds_ar:"١٥٠غ لحم أنغوس، شيدر، بصل أخضر، طماطم، مخلّل، خس، مع صلصة سريراتشا الحارّة وصلصة الديناميت المنزليّة.", sm:["12,000","15,000"], img:"/images/item-dynamite-burger.jpg", imgPos:"center 55%"},
      {nm_en:"Chili N Cheese", nm_ar:"تشيلي آند تشيز",
       ...
       ds_ar:"١٥٠غ لحم أنغوس، شيدر، بصل، طماطم، هالبينو، مايونيز الثوم، مع صلصة التشيلي الحارّة المنزليّة.", sm:["12,000","15,000"], img:"/images/item-chili-cheese.jpg", imgPos:"center 45%"},
      {nm_en:"Beef Bacon Jam", nm_ar:"بيف بيكون جام",
       ...
       ds_ar:"١٥٠غ لحم أنغوس، جبن مدخّن، بصل، طماطم، مخلّل، مايونيز الثوم، مع وصفة مربّى لحم البقري المدخّن من كيوب.", sm:["13,000","16,000"], img:"/images/item-beef-bacon-jam.jpg", imgPos:"center 55%"}
    ]
  },
  {
    ...
    items:[
      {nm_en:"Chicken Ranch", nm_ar:"تشيكن رانش",
       ...
       ds_ar:"صدر دجاج مقلي مقرمش، صلصة بافلو، شيدر، خس، طماطم، بصل، مخلّل، مع صلصة الرانش.", sm:["9,750","12,750"], img:"/images/item-chicken-ranch.jpg", imgPos:"center 45%"},
      {nm_en:"Rebel Chicken", nm_ar:"ريبل تشيكن",
       ...
       ds_ar:"صدر دجاج مقلي مقرمش، مايونيز الثوم، مخلّل، بصل، شيدر، مع شرائح ديك رومي مدخّن ولمسة كول سلو.", sm:["11,750","14,750"], img:"/images/item-rebel-chicken.jpg", imgPos:"center 55%"},
