export const MENU = [
  {
    ...
    items:[
      {nm_en:"Dynamite Shrimps", nm_ar:"روبيان ديناميت",
       ...
       ds_ar:"روبيان مقلي مقرمش متبّل بصلصة مايونيز حارّة ولاذعة.", price:"14,000", img:"/images/item-dynamite-shrimps.jpg"},
      {nm_en:"Dynamite Chicken", nm_ar:"دجاج ديناميت",
       ...
       ds_ar:"قطع صدر دجاج مقلية مقرمشة بصلصة مايونيز حارّة ولاذعة.", price:"9,750", img:"/images/item-dynamite-chicken.jpg"},
      {nm_en:"Crab Balls 5 pcs", nm_ar:"كرات السلطعون ٥ قطع",
       ...
       ds_ar:"خمس كرات من لحم السلطعون وجبنة الكريمة والبصل الأخضر، تُقدّم مع صلصة الديناميت الحارّة.", price:"8,500", img:"/images/item-crab-balls.jpg"},
  ...
  },
  {
    ...
    items:[
      {nm_en:"French Fries", nm_ar:"بطاطا مقلية", price:"3,500", img:"/images/item-french-fries.jpg"},
      {nm_en:"Curly Fries", nm_ar:"بطاطا كيرلي", price:"5,250", img:"/images/item-curly-fries.jpg"},
      {nm_en:"Cube French Fries", nm_ar:"بطاطا كيوب",
       ds_en:"Served with garlic mayo.", ds_ar:"تُقدّم مع مايونيز الثوم.", price:"5,750", img:"/images/item-cube-fries.jpg"},
      {nm_en:"Texas Fries", nm_ar:"بطاطا تكساس",
       ds_en:"Cheesy fries topped with hot chili sauce, jalapeños & garnished with beef bacon.",
       ds_ar:"بطاطا بالجبن مع صلصة الفلفل الحار والهالبينو ولحم بقري مدخّن.", price:"8,750", img:"/images/item-texas-fries.jpg"},
  ...
  },
  {
    ...
    items:[
      {nm_en:"Caesar Salad", nm_ar:"سلطة سيزر",
       ...
       img:"/images/item-caesar-salad.jpg",
       opts:[
      ...
      {nm_en:"Summer Garden", nm_ar:"حديقة الصيف",
       ...
       ds_ar:"خضار مشكّلة وطماطم كرزيّة وخيار وملفوف أحمر وبصل أخضر وكروتون بصلصة الفيتا، مع شرائح الونتون والزيتون الأسود.", price:"8,500", img:"/images/item-summer-garden.jpg"},
      {nm_en:"Cube Salad", nm_ar:"سلطة كيوب",
       ...
       ds_ar:"صدر دجاج مشوي على خضار مشكّلة وملفوف أحمر وبصل أخضر مع كروتون بصلصة البلسميك، مغطّى بصلصة الذرة، مرشوش بتشيبوتلي رانش ومزيّن بشرائح الونتون. يُقدّم مع كاساديا بالجبن.", price:"14,750", img:"/images/item-cube-salad.jpg"},
      {nm_en:"Crab Salad", nm_ar:"سلطة السلطعون",
       ...
       ds_ar:"شرائح لحم سلطعون وجزر وخيار بصلصة محلّاة، مع الملفوف الأحمر وشرائح الونتون والكاجو.", price:"13,750", img:"/images/item-crab-salad.jpg"},
      {nm_en:"Buffalo Chicken Ranch", nm_ar:"دجاج بافلو رانش", available:false,
  ...
  },
  {
    ...
    items:[
      {nm_en:"Buffalo · Honey Mustard · BBQ", nm_ar:"بافلو · هاني مسترد · باربكيو",
       ...
       img:"/images/item-boneless-classic.jpg",
       opts:[
      ...
      {nm_en:"Parmesan Buffalo · Crazy Bites · Garlic Parmesan", nm_ar:"بارميزان بافلو · كريزي بايتس · غارليك بارميزان",
       ds_en:"Bites of chicken breast, hand-breaded, deep fried to golden crispy & tossed in your choice of our homemade sauces.",
       ds_ar:"قطع صدر دجاج مغطّاة يدويًا ومقليّة حتى الذهبيّة والقرمشة، متبّلة بصلصتك المفضّلة.",
       img:"/images/item-boneless-premium.jpg",
       opts:[
      ...
      {nm_en:"Kids Chicken Bites · 5 pcs", nm_ar:"قطع دجاج للأطفال · ٥ قطع",
       ...
       ds_ar:"قطع دجاج مقرمشة مع بطاطا واختيارك من الهاني مسترد أو الباربكيو. تُقدّم مع عصير.", price:"9,000", img:"/images/item-kids-bites.png"}
    ],
    meal:true
  },
  {
    ...
    items:[
      {nm_en:"Buffalo · Honey Mustard · BBQ", nm_ar:"بافلو · هاني مسترد · باربكيو",
       img:"/images/item-wings-classic.jpg",
       opts:[
      ...
      {nm_en:"Garlic Parmesan · Crazy Wings · Buffalo & BBQ Mix", nm_ar:"غارليك بارميزان · كريزي وينغز · مكس بافلو وباربكيو",
       img:"/images/item-wings-premium.jpg",
       opts:[
  ...
  },
  {
    ...
    items:[
      {nm_en:"Cube Burger", nm_ar:"برجر كيوب",
       ...
       ds_ar:"١٥٠غ لحم أنغوس، جبن مشكّل، خس، طماطم، بصل ومخلّل، مع صلصة كيوب الخاصة.", sm:["11,000","14,000"], img:"/images/item-cube-burger.jpg"},
      {nm_en:"Classic Burger", nm_ar:"برجر كلاسيك",
       ...
       ds_ar:"١٥٠غ لحم أنغوس، جبن مشكّل، كاتشب، مايونيز الثوم، مسترد، خس، طماطم، بصل ومخلّل.", sm:["11,000","14,000"], img:"/images/item-classic-burger.jpg"},
      {nm_en:"Hard Rock Style", nm_ar:"هارد روك ستايل",
       ...
       ds_ar:"١٥٠غ لحم أنغوس، جبن أبيض، طماطم، مخلّل، مايونيز الثوم مع فطر وبصل مشوّح، بأسلوب هارد روك.", sm:["12,000","15,000"], img:"/images/item-hard-rock.jpg"},
  ...
  },
  {
    ...
    items:[
      {nm_en:"Chicken Ranch", nm_ar:"تشيكن رانش",
       ...
       ds_ar:"صدر دجاج مقلي مقرمش، صلصة بافلو، شيدر، خس، طماطم، بصل، مخلّل، مع صلصة الرانش.", sm:["9,750","12,750"], img:"/images/item-chicken-ranch.jpg"},
      {nm_en:"Rebel Chicken", nm_ar:"ريبل تشيكن",
       ...
       ds_ar:"صدر دجاج مقلي مقرمش، مايونيز الثوم، مخلّل، بصل، شيدر، مع شرائح ديك رومي مدخّن ولمسة كول سلو.", sm:["11,750","14,750"], img:"/images/item-rebel-chicken.jpg"},
      {nm_en:"Grilled Chicken", nm_ar:"دجاج مشوي",
       ...
       ds_ar:"صدر دجاج مشوي متبّل بوصفة الشيف، جبن أبيض، مايونيز الثوم، خس، طماطم، بصل ومخلّل.", sm:["8,750","11,750"], img:"/images/item-grilled-chicken.jpg"},
      {nm_en:"Chicken Philly Cheese Steak", nm_ar:"فيلي تشيز ستيك بالدجاج",
       ...
       ds_ar:"قطع صدر دجاج، جبن مشكّل، فطر طازج، بصل، فلفل ملوّن، مايونيز الثوم.", sm:["10,000","13,000"], img:"/images/item-chicken-philly.jpg"}
    ],
